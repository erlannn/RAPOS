...
<body class="font-sans antialiased bg-slate-100">
    <div x-data="{ sidebarOpen: true, sidebarDesktopOpen: true, masterDataOpen: false, inventoryOpen: false }" class="min-h-screen">
        <div class="flex min-h-screen bg-slate-100">
            <aside
                ...
                :class="[sidebarOpen ? 'translate-x-0' : '-translate-x-full', sidebarDesktopOpen ? 'lg:translate-x-0' : 'lg:-translate-x-full']"
            >
                ...
                <nav class="space-y-2 px-4 py-5 text-sm font-medium">
                    ...
                    <div>
                        ...
                        <div x-cloak x-transition class="mt-2 space-y-1 pl-4" style="display: none;" :style="masterDataOpen ? 'display: block;' : 'display: none;'">
                    ...
                    <div>
                        ...
                        <div x-cloak x-transition class="mt-2 space-y-1 pl-4" style="display: none;" :style="inventoryOpen ? 'display: block;' : 'display: none;'">
            ...
            <div class="flex min-h-screen flex-1 flex-col" :class="sidebarDesktopOpen ? 'lg:pl-72' : 'lg:pl-0'">
                <header class="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur">
                    <div class="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
                        <div class="flex items-center gap-3">
                            <button type="button" @click="sidebarOpen = ! sidebarOpen; sidebarDesktopOpen = sidebarOpen" class="inline-flex items-center gap-2 rounded-lg border border-slate-200 px-3 py-2 text-slate-600 transition hover:bg-slate-100">
                            ...
                            <div class="hidden lg:block text-sm text-slate-500">{{ config('app.name', 'RAPOS') }}</div>
                        </div>
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open" x-transition x-cloak @click.outside="open = false" class="absolute right-0 mt-2 w-56 rounded-2xl border border-slate-200 bg-white p-2 shadow-xl">
        ...
        <div x-show="sidebarOpen" x-transition.opacity x-cloak class="fixed inset-0 z-30 bg-slate-900/50 lg:hidden" @click="sidebarOpen = false"></div>
    </div>
</body>
</html>
