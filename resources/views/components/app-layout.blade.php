        ...
        <div id="app-shell" class="flex min-h-screen bg-slate-100">
            <aside
                ...
                <nav class="space-y-2 px-3 py-5 text-sm font-medium">
                    ...
                    @role('Admin')
                    <div>
                        <button type="button" @click="masterDataOpen = ! masterDataOpen" class="flex w-full items-center rounded-xl px-3 py-3 text-slate-300 transition hover:bg-white/10 {{ request()->is('master-data*') ? 'bg-white/10 text-white' : '' }}" :class="sidebarOpen ? 'justify-between' : 'justify-center'">
                        ...
                        <div x-show="sidebarOpen && masterDataOpen" x-transition class="mt-2 space-y-1 pl-4" style="display: none;">
                            <a href="{{ route('produk.index') }}" class="block rounded-lg px-4 py-2 text-slate-300 transition hover:bg-white/10 {{ request()->routeIs('produk.*') ? 'bg-white/10 text-white' : '' }}">Produk</a>
                            <a href="{{ route('supplier.index') }}" class="block rounded-lg px-4 py-2 text-slate-300 transition hover:bg-white/10 {{ request()->routeIs('supplier.*') ? 'bg-white/10 text-white' : '' }}">Supplier</a>
                            <a href="{{ route('brand.index') }}" class="block rounded-lg px-4 py-2 text-slate-300 transition hover:bg-white/10 {{ request()->routeIs('brand.*') ? 'bg-white/10 text-white' : '' }}">Brand</a>
                            <a href="{{ route('departemen.index') }}" class="block rounded-lg px-4 py-2 text-slate-300 transition hover:bg-white/10 {{ request()->routeIs('departemen.*') ? 'bg-white/10 text-white' : '' }}">Departemen</a>
                            <a href="{{ route('kategori.index') }}" class="block rounded-lg px-4 py-2 text-slate-300 transition hover:bg-white/10 {{ request()->routeIs('kategori.*') ? 'bg-white/10 text-white' : '' }}">Kategori</a>
                            <a href="{{ route('subkategori.index') }}" class="block rounded-lg px-4 py-2 text-slate-300 transition hover:bg-white/10 {{ request()->routeIs('subkategori.*') ? 'bg-white/10 text-white' : '' }}">Sub Kategori</a>
                            <a href="{{ route('store.index') }}" class="block rounded-lg px-4 py-2 text-slate-300 transition hover:bg-white/10 {{ request()->routeIs('store.*') ? 'bg-white/10 text-white' : '' }}">Store</a>
                        </div>
                    </div>
                    @endrole

                    <div>
                        <button type="button" @click="inventoryOpen = ! inventoryOpen" class="flex w-full items-center rounded-xl px-3 py-3 text-slate-300 transition hover:bg-white/10 {{ request()->is('inventory*') ? 'bg-white/10 text-white' : '' }}" :class="sidebarOpen ? 'justify-between' : 'justify-center'">
                            <span class="flex items-center" :class="sidebarOpen ? 'gap-3' : 'justify-center'">
