...
<body class="font-sans text-gray-900 antialiased bg-gradient-to-r from-gray-200 to-blue-500">
    ...
    <div class="flex flex-col items-center justify-center min-h-screen">
        <div class="text-5xl font-bold text-red-600">404</div>
        <div class="text-2xl font-semibold text-gray-800 mt-4">Tidak Ditemukan</div>
        <div class="text-gray-800 mt-2">Maaf, halaman yang anda cari tidak ditemukan</div>
