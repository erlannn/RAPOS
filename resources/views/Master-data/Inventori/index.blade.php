        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-3">
                <div class="flex gap-3">
                    <a href="{{ route('inventori.create') }}" class="bg-blue-600 text-white px-3 py-2 rounded-lg shadow hover:bg-blue-700 text-sm flex items-center">
                        + Tambah Inventori
                    </a>
                </div>
            </div>
...
<th class="px-3 py-2 border">StokSaatIni</th>
<th class="px-3 py-2 border">MinimumStok</th>
<th class="px-3 py-2 border">HargaBeliTerakhir</th>
<th class="px-3 py-2 border">HargaJual</th>
